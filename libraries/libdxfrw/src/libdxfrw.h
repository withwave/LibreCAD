...
public:
     ...
     */
    [[nodiscard]] bool read(DRW_Interface *interface_, bool ext, const std::string &codePage = "");
    [[nodiscard]] bool readAscii(DRW_Interface *interface_, bool ext, std::string& content, const std::string &codePage = "");
