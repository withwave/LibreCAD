...
public:
  ...
  static QString toNativeString(const QString &data, bool preserveHeight = false);
...
#define LIBDXFRW_VERSION(version, release, patch)                              \
  ...
  std::map<QString, std::unique_ptr<RS_Block>> m_dimensionGraphics;
  void restoreDimensionGraphics(RS_Dimension* entity, const DRW_Dimension* source);
